...
const BlogSection = () => {
  return (
    <div className="w-full px-4 lg:px-0 lg:w-[1320px] flex items-center justify-center ">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 text-white w-full">
        {/* Main Blog Card */}
        <div className="w-full  rounded-[24px] border-[0.6px] border-[#13D28A99] p-[16px] lg:p-[24px] mb-5 lg:mb-0">
          <div>
            <img
          ...
          <div className="flex flex-col gap-[20px] lg:gap-[42px] mt-5">
            ...
            <div>
              <button className="w-[120px] text-nowrap h-[40px] lg:w-[131px] lg:h-[44px] rounded-[6px] border-[1px] py-[10px] lg:py-[12px] px-[20px] lg:px-[24px] flex items-center justify-center text-black bg-[#13D28A]">
            ...
            .map((_, index) => (
              ...
              >
                ...
                <div className="w-[237.5px] flex flex-col mt-4">
                  ...
                  <button className="w-[120px] h-[40px] lg:w-[131px] lg:h-[44px] rounded-[6px] border-[1px] py-[10px] lg:py-[12px] px-[20px] lg:px-[24px] flex items-center justify-center mt-4 text-nowrap">
                    <span>Learn More</span>
                  </button>
                </div>
              </div>
