...
const HelpfullToolsCard = () => {
  return (
    <div className="w-full sm:w-[419px] h-auto sm:h-[357px] border-[0.7px] rounded-[12px] p-[24px] flex flex-col items-center justify-center border-[#13D28A99]/60 text-white">
      {/* Icon Container */}
      ...
      {/* Description */}
      <div className="w-full sm:w-[318px] h-auto opacity-[95%] text-center">
