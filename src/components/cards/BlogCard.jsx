      ...
      <div className="flex flex-col gap-[12px] lg:gap-[20px] mt-5">
        ...
        <div>
          <a
            ...
            className="w-[100px] lg:w-[120px] xl:w-[140px] h-[35px] lg:h-[40px] xl:h-[44px] rounded-[6px] border-[1px] py-[8px] lg:py-[10px] xl:py-[12px] px-[16px] lg:px-[20px] xl:px-[24px] flex items-center justify-center text-black bg-[#13D28A] text-nowrap"
          >
